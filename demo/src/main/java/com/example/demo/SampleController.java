...
// @RestController만 쓰면 @ResponseBody 안적어도 됨
...
//	@ResponseBody
	...
	public String[] getPath(@PathVariable String cat, @PathVariable(name="pid") Integer prdid) {
	...
	public JsonNode compMap(@RequestBody JsonNode node) {
		...
		// 첫번째 티켓의 owner 출력
		log.info("compMap owner : " + node.get("list").get(0).get("owner").asText() );
